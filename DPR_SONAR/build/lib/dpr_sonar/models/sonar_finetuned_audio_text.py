...
cfg.model_file='/export/data2/sli/checkpoints/sonar_dpr_finetune_audio_text/dpr_biencoder.0' #'/export/data2/sli/checkpoints/sonar_dpr_finetune/dpr_biencoder.0'
...
with open('/home/sli/DPR_SONAR/results/tst_term_pairs_dpr_sonar_finetune_q_n_p_audio_text_10.txt','w') as f:
        for item in tst_term_pairs:
               f.write('{} \n'.format(item))

for i,pair in enumerate(tst_term_pairs):
    if i==0:
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_1st_NN_3.txt','w') as g: #
            g.write(term_lines[pair[1][0]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_2st_NN_3.txt','w') as g: #
            g.write(term_lines[pair[1][1]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_3st_NN_3.txt','w') as g: #
            g.write(term_lines[pair[1][2]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
    else:
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_1st_NN_3.txt','a') as g: #
            g.write(term_lines[pair[1][0]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_2st_NN_3.txt','a') as g: #
            g.write(term_lines[pair[1][1]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
        with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_3st_NN_3.txt','a') as g: #
            g.write(term_lines[pair[1][2]].strip()+' <SEP> '+lines_tst_origin[pair[0]])
print("saved txt files")
with open('/home/sli/DPR_SONAR/results/tst_with_retrieved_example_dpr_sonar_finetune_q_n_p_audio_text_1st_NN_3.txt',encoding='utf-8') as f:
    lines = f.readlines()
import json
